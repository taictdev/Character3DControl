...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void CameraRotation()
        {
            ...
            if (Joystick.Direction.sqrMagnitude >= _threshold && !LockCameraPosition)
            {
                //Don't multiply mouse input by Time.deltaTime;
                float deltaTimeMultiplier = IsCurrentDeviceMouse ? 1.0f : Time.deltaTime;

                _cinemachineTargetYaw += Joystick.Direction.x * deltaTimeMultiplier;
                _cinemachineTargetPitch += Joystick.Direction.y * deltaTimeMultiplier;
            }
            ...
            //CinemachineCameraTarget.transform.localRotation = Quaternion.Euler(yRotation , xRotation, 0);

            // clamp our rotations so our values are limited 360 degrees
            //_cinemachineTargetYaw = ClampAngle(mouseX, float.MinValue, float.MaxValue);
            //_cinemachineTargetPitch = ClampAngle(mouseY, BottomClamp, TopClamp);
        ...
        private void Move()
        {
            ...
            if (Joystick.Direction == Vector2.zero) targetSpeed = 0.0f;
            ...
            float inputMagnitude = Joystick.Direction.magnitude;
            ...
            Vector3 inputDirection = new Vector3(Joystick.Direction.x, 0.0f, Joystick.Direction.y).normalized;
